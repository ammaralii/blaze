...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEMPLATEFIELD_LIST actions', async () => {
    ...
    it('dispatches FETCH_TEMPLATEFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TEMPLATEFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TEMPLATEFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TEMPLATEFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TEMPLATEFIELD actions', async () => {
      const expectedActions = [
        {
