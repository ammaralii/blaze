...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './test-case-priority.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTCASEPRIORITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTCASEPRIORITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTCASEPRIORITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTCASEPRIORITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTCASEPRIORITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTCASEPRIORITY actions', async () => {
      const expectedActions = [
        {
