...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './test-run.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTRUN_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTRUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTRUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTRUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTRUN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTRUN actions', async () => {
      const expectedActions = [
        {
