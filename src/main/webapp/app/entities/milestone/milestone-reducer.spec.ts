...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './milestone.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MILESTONE_LIST actions', async () => {
    ...
    it('dispatches FETCH_MILESTONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MILESTONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MILESTONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MILESTONE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MILESTONE actions', async () => {
      const expectedActions = [
        {
