...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTCASEFIELD_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTCASEFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTCASEFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTCASEFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTCASEFIELD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTCASEFIELD actions', async () => {
      const expectedActions = [
        {
