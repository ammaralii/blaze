...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTSUITE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTSUITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTSUITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTSUITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTSUITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTSUITE actions', async () => {
      const expectedActions = [
        {
