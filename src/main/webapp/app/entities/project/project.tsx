                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {project.defaultTemplate ? (
                      <Link to={`/template/${project.defaultTemplate.id}`}>{project.defaultTemplate.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
                  <td>{project.company ? <Link to={`/company/${project.company.id}`}>{project.company.id}</Link> : ''}</td>
