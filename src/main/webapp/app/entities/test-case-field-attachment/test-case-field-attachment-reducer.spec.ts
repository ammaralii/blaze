...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './test-case-field-attachment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTCASEFIELDATTACHMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTCASEFIELDATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTCASEFIELDATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTCASEFIELDATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTCASEFIELDATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTCASEFIELDATTACHMENT actions', async () => {
      const expectedActions = [
        {
