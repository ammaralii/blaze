...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './test-plan.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTPLAN_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTPLAN actions', async () => {
      const expectedActions = [
        {
