...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTSTATUS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTSTATUS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTSTATUS actions', async () => {
      const expectedActions = [
        {
