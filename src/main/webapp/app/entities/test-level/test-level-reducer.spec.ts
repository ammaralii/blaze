...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTLEVEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTLEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTLEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTLEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTLEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTLEVEL actions', async () => {
      const expectedActions = [
        {
