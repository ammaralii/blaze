...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './test-case-attachment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTCASEATTACHMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTCASEATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTCASEATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTCASEATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTCASEATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTCASEATTACHMENT actions', async () => {
      const expectedActions = [
        {
