...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './test-run-step-details.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTRUNSTEPDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTRUNSTEPDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTRUNSTEPDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTRUNSTEPDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTRUNSTEPDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTRUNSTEPDETAILS actions', async () => {
      const expectedActions = [
        {
