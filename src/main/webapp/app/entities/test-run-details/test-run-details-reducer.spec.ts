...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTRUNDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTRUNDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTRUNDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTRUNDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTRUNDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTRUNDETAILS actions', async () => {
      const expectedActions = [
        {
