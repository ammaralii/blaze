...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './template-field-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEMPLATEFIELDTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_TEMPLATEFIELDTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TEMPLATEFIELDTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TEMPLATEFIELDTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TEMPLATEFIELDTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TEMPLATEFIELDTYPE actions', async () => {
      const expectedActions = [
        {
