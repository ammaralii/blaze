...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './test-run-step-detail-attachment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TESTRUNSTEPDETAILATTACHMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TESTRUNSTEPDETAILATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TESTRUNSTEPDETAILATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TESTRUNSTEPDETAILATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TESTRUNSTEPDETAILATTACHMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TESTRUNSTEPDETAILATTACHMENT actions', async () => {
      const expectedActions = [
        {
