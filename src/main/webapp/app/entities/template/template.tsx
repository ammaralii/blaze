            ...
            <tbody>
              {templateList.map((template, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{template.createdAt ? <TextFormat type="date" value={template.createdAt} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{template.createdBy}</td>
                  <td>{template.company ? <Link to={`/company/${template.company.id}`}>{template.company.id}</Link> : ''}</td>
